...
## `synthetic/materials_challenge.csv`

Conjunto separado com abreviações, descrições incomuns e exceções. Ele foi
criado para revelar onde as regras do baseline não generalizam.

O desempenho no primeiro arquivo mede aderência aos casos conhecidos. O
desempenho no conjunto de desafio é uma estimativa mais honesta da fragilidade
do sistema diante de novas formas de escrever o mesmo domínio.
